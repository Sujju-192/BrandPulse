...
export default function Landing() {
  ...
  const stats = [
    { value: '10K+', label: 'Brands Launched', icon: <Rocket className="w-4 h-4" />, color: "from-purple-500 to-pink-500" },
  ...
  const features = [
    {
      ...
      items: [
        ...
        { icon: <Target className="w-5 h-5" />, title: 'BrandPulse Engine', desc: 'Autonomous theme & positioning' },
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <Globe className="w-5 h-5" />, title: 'Multi-Language', desc: 'Global BrandPulse support' },
      ]
    }
  ];
      ...
      >
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className="text-2xl font-light tracking-tight">BrandPulse <span className="font-bold">AI</span></span>
          </motion.div>
      ...
      <section ref={featuresRef} id="features" className="relative container mx-auto px-6 py-20 scroll-mt-20">
        <div className="text-center mb-16">
          ...
          <motion.p 
            ...
            transition={{ delay: 0.2 }}
          >
            From strategy to execution, our AI handles every aspect of brand creation
          </motion.p>
        </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <motion.p 
                ...
                transition={{ delay: 0.2 }}
              >
                Join forward-thinking businesses already accelerating with BrandPulse AI.
              </motion.p>
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            >
              ...
              <div>
                <div className="text-xl font-light">BrandPulse <span className="font-bold">AI</span></div>
                <div className="text-sm text-gray-500">AI-powered business growth</div>
              </div>
            </motion.div>
            
            <div className="text-center md:text-right">
              <div className="text-gray-500 text-sm mb-2">© 2024 BrandPulse AI. All rights reserved.</div>
